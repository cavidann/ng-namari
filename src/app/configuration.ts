export const configuration = {
  ...
  client: {
    ...
    companies: [
      ...
      {name: 'Cold', weblink: 'company-logo9.pn', logo: 'company-logo9.png'}
    ]
  },
  pricing: {
    tagline: 'YOUR CHOICE',
  ...
  footer: {
    ...
    developer: 'Cavidan Talıbov',
    developerLink: 'https://cavidann.github.io/ng-cv/'
  },
  social: [
    {title: 'Facebook', target: '_blank', link: 'https://www.facebook.com/', username: 'mark', icon: 'facebook'},
    {title: 'Google+', target: '_blank', link: 'http://google.com/', username: 'mark', icon: 'google-plus'},
    {title: 'Twitter', target: '_blank', link: 'http://www.twitter.com/', username: 'mark', icon: 'twitter'},
    {title: 'Instagram', target: '_blank', link: 'http://www.instagram.com/', username: 'mark', icon: 'instagram'},
    {title: 'Behance', target: '_blank', link: 'http://www.behance.net/', username: 'mark', icon: 'behance'}
  ],
  blog: {
    tagline: 'MY BLOG',
    title: 'THOUGS BECOME THINGS...'
  },
};
